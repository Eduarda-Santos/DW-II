<?php
	...
	function rotas($url) {
		...
		// ALTERAR
			...
			// Obtem dados do pessoa escolhcpfo para alteração
		...
		// Excluir
		else if(strcmp($dados[0], "excluir") == 0){
			echo "<script> window.location='viewExcluir.php' </script>";
		}
	}
				...
				echo "<tr>";
					...
					echo "<td>";
						echo "<button type='submit' name='acao' value='alterar/".$cpf."' class='btn btn-success'>";
							echo "<svg xmlns='http://www.w3.org/2000/svg' wcpfth='18' height='18' fill='#FFF' class='bi bi-arrow-counterclockwise' viewBox='0 0 16 16'>";
						...
						echo "</button>";
						echo "&nbsp";
						echo "<button type='submit' name='acao' value='excluir/".$cpf."' class='btn btn-danger'>";
							echo "<svg xmlns='http://www.w3.org/2000/svg' wcpfth='18' height='18' fill='#FFF' class='bi bi-trash-fill' viewBox='0 0 16 16'>";
								echo "<path fill-rule='evenodd' d='M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2v1z'/>";
