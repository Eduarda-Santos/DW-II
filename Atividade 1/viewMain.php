...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastrar Pessoas Físicas</title>
        ...
        <form action="viewMain.php" method="POST">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <button type="submit" name="acao" value="cadastrar/".$cpf. class="btn btn-primary btn-lg btn-block">Cadastrar Nova Pessoa Física</button>
                        <thead>
                        <tr>
